...
var require_events = __commonJS(() => {
  var EventEmitter = function(opts) {
    ...
    throwNotImplemented2("events.on", 2679);
  }, getEventListeners = function(emitter, type) {
    if (emitter instanceof EventTarget)
      throwNotImplemented2("getEventListeners with an EventTarget", 2678);
  ...
  }, { throwNotImplemented: throwNotImplemented2 } = (init_shared(), __toCommonJS(exports_shared)), { isPromise, Array, Object: Object2 } = globalThis[Symbol.for("Bun.lazy")]("primordials"), SymbolFor = Symbol.for, kCapture = Symbol("kCapture"), kErrorMonitor = SymbolFor("events.errorMonitor"), kMaxEventTargetListeners = Symbol("events.maxEventTargetListeners"), kMaxEventTargetListenersWarned = Symbol("events.maxEventTargetListenersWarned"), kWatermarkData = SymbolFor("nodejs.watermarkData"), kRejection = SymbolFor("nodejs.rejection"), captureRejectionSymbol = SymbolFor("nodejs.rejection"), ArrayPrototypeSlice = Array.prototype.slice, defaultMaxListeners = 10, EventEmitterPrototype = EventEmitter.prototype;
  ...
  var emitWithoutRejectionCapture = function emit(type, ...args) {
    ...
    return !0;
  }, emitWithRejectionCapture = function emit(type, ...args) {
    if (type === "error")
      return emitError(this, args);
    var { _events: events } = this;
    if (events === void 0)
  ...
  Object2.defineProperty(EventEmitter, "captureRejections", {
    get() {
  ...
  class EventEmitterAsyncResource extends EventEmitter {
    ...
    constructor(options) {
      if (!AsyncResource)
        AsyncResource = $_BunCommonJSModule_$.require("node:async_hooks").AsyncResource;
  ...
  $_BunCommonJSModule_$.module.exports = Object2.assign(EventEmitter, {
    once,
    on,
    getEventListeners,
    setMaxListeners,
