...
}, { throwNotImplemented: throwNotImplemented2 } = exports_shared, { isPromise, Array, Object: Object2 } = globalThis[Symbol.for("Bun.lazy")]("primordials"), SymbolFor = Symbol.for, kCapture = Symbol("kCapture"), kErrorMonitor = SymbolFor("events.errorMonitor"), kMaxEventTargetListeners = Symbol("events.maxEventTargetListeners"), kMaxEventTargetListenersWarned = Symbol("events.maxEventTargetListenersWarned"), kWatermarkData = SymbolFor("nodejs.watermarkData"), kRejection = SymbolFor("nodejs.rejection"), captureRejectionSymbol = SymbolFor("nodejs.rejection"), ArrayPrototypeSlice = Array.prototype.slice, defaultMaxListeners = 10, EventEmitterPrototype = EventEmitter.prototype;
...
class EventEmitterAsyncResource extends EventEmitter {
  ...
  constructor(options) {
    if (!AsyncResource)
      AsyncResource = module.require("node:async_hooks").AsyncResource;
...
module.exports = Object2.assign(EventEmitter, {
  once,
  on,
  getEventListeners,
  getMaxListeners,
