(function () {"use strict";
  const types = @requireBuiltin(1030);
  var cjs_exports = {};
  ...
  const deepEquals = Bun.deepEquals, isDeepStrictEqual = (a, b) => deepEquals(a, b, !0);
  var getOwnPropertyDescriptors = Object.getOwnPropertyDescriptors, formatRegExp = /%[sdj%]/g;
  function format(f) {
    if (!isString(f)) {
      var objects = [];
  ...
  var { isDate, isNativeError: isError } = types;
  ...
  return Object.assign(cjs_exports, {
    format,
    deprecate,
    debuglog,
    _extend,
