...
// src/js/out/tmp/node/http2.ts
var require_http2 = __commonJS(() => {
  var connect = function() {
    throwNotImplemented2("node:http2 connect", 887);
  }, createServer = function() {
    throwNotImplemented2("node:http2 createServer", 887);
  }, createSecureServer = function() {
    throwNotImplemented2("node:http2 createSecureServer", 887);
    ...
    throwNotImplemented2("node:http2 Http2ServerRequest", 887);
  }, Http2ServerResponse = function() {
    throwNotImplemented2("node:http2 Http2ServerResponse", 887);
  }, { hideFromStack: hideFromStack2, throwNotImplemented: throwNotImplemented2 } = (init_shared(), __toCommonJS(exports_shared)), constants = {
