<<<<<<< HEAD
<<<<<<< HEAD
(()=>{"use strict";var {module}=$_BunCommonJSModule_$;var parseCertString = function() {
...
(function () {"use strict";
  ...
  function unfqdn(host2) {
    return RegExpPrototypeSymbolReplace.call(/[.]$/, host2, "");
  }
  function toLowerCase(c) {
    return StringFromCharCode.call(32 + StringPrototypeCharCodeAt.call(c, 0));
  }
  function splitHost(host2) {
    return StringPrototypeSplit.call(RegExpPrototypeSymbolReplace.call(/[A-Z]/g, unfqdn(host2), toLowerCase), ".");
  }
  ...
  const CLIENT_RENEG_LIMIT = 3, CLIENT_RENEG_WINDOW = 600, DEFAULT_ECDH_CURVE = "auto", DEFAULT_CIPHERS = "DHE-RSA-AES256-GCM-SHA384:DHE-RSA-AES128-GCM-SHA256:ECDHE-RSA-AES256-GCM-SHA384:ECDHE-RSA-AES128-GCM-SHA256", DEFAULT_MIN_VERSION = "TLSv1.2", DEFAULT_MAX_VERSION = "TLSv1.3", createConnection = (port, host2, connectListener) => {
    if (typeof port === "object") {
      port.checkServerIdentity;
      const { ALPNProtocols } = port;
      if (ALPNProtocols)
  ...
  var rootCertificates = globalThis[globalThis.Symbol.for('Bun.lazy')]("rootCertificates");
  return {
    CLIENT_RENEG_LIMIT,
    CLIENT_RENEG_WINDOW,
    connect,
