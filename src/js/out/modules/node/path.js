(function () {"use strict";
  ...
  const posix = bound(Bun._Path(!1)), win32 = bound(Bun._Path(!0));
  return posix.win32 = win32.win32 = win32, posix.posix = win32.posix = posix, process.platform === "win32" ? win32 : posix;
})
