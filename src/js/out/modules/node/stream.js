(()=>{"use strict";var {module}=$_BunCommonJSModule_$;var isReadableStream = function(value) {
...
var debug = () => {
}, { isPromise, isCallable, direct, Object } = globalThis[Symbol.for("Bun.lazy")]("primordials"), { EventEmitter: EE } = module.require("bun:events_native"), StringDecoder = module.require("node:string_decoder").StringDecoder, __defProp = Object.defineProperty, __getOwnPropDesc = Object.getOwnPropertyDescriptor, __getOwnPropNames = Object.getOwnPropertyNames, __hasOwnProp = Object.prototype.hasOwnProperty, __commonJS = (cb, mod) => function __require2() {
...
`;
  ...
  "node_modules/readable-stream/lib/internal/streams/readable.js"(exports, module) {
    var {
      ...
      SymbolAsyncIterator,
      Symbol: Symbol2
    } = require_primordials(), ReadableState = globalThis[Symbol.for("Bun.lazy")]("bun:stream").ReadableState, { Stream, prependListener } = require_legacy();
...
}, exports = require_stream(), promises = require_promises(), originalDestroy = exports.Readable.destroy;
