(function () {"use strict";
  console.log("streams!");
  const __TRACK_EE__ = !1, __DEBUG__ = !1;
  if (__DEBUG__)
  ...
  const { EventEmitter: EE } = @requireBuiltin(1026), StringDecoder = @requireBuiltin(1027).StringDecoder;
  var { defineProperty: __defProp, getOwnPropertyDescriptor: __getOwnPropDesc, getOwnPropertyNames: __getOwnPropNames } = Object, __hasOwnProp = Object.prototype.hasOwnProperty, __commonJS = (cb, mod) => function __require2() {
  ...
  const validateObject = (value, name, options = null) => {
    ...
    if (!(options?.nullable ?? !1) && value === null || !allowArray && ArrayIsArray(value) || typeof value !== "object" && (!allowFunction || typeof value !== "function"))
  ...
  var require_primordials = __commonJS({
    "node_modules/readable-stream/lib/ours/primordials.js"(exports2, module) {
      module.exports = {
        ArrayIsArray(self) {
    ...
    "node_modules/readable-stream/lib/ours/util.js"(exports2, module) {
...
`;
    ...
    "node_modules/readable-stream/lib/ours/errors.js"(exports2, module) {
    ...
    "node_modules/readable-stream/lib/internal/validators.js"(exports2, module) {
      var {
    ...
    "node_modules/readable-stream/lib/internal/streams/utils.js"(exports2, module) {
    ...
    "node_modules/readable-stream/lib/internal/streams/operators.js"(exports2, module) {
      var {
    ...
    "node_modules/readable-stream/lib/internal/streams/legacy.js"(exports2, module) {
    ...
    "node_modules/readable-stream/lib/internal/streams/add-abort-signal.js"(exports2, module) {
    ...
    "node_modules/readable-stream/lib/internal/streams/readable.js"(exports2, module) {
      var {
    ...
    "node_modules/readable-stream/lib/internal/streams/writable.js"(exports2, module) {
      var {
        ArrayPrototypeSlice,
        Error: Error2,
      ...
      ObjectSetPrototypeOf(Writable2.prototype, Stream.prototype), ObjectSetPrototypeOf(Writable2, Stream), module.exports = Writable2;
      function nop() {
      }
    ...
    "node_modules/readable-stream/lib/internal/streams/duplexify.js"(exports2, module) {
      var {
        isReadable,
        isWritable,
        isIterable,
    ...
    "node_modules/readable-stream/lib/internal/streams/duplex.js"(exports2, module) {
    ...
    "node_modules/readable-stream/lib/internal/streams/transform.js"(exports2, module) {
    ...
    "node_modules/readable-stream/lib/internal/streams/passthrough.js"(exports2, module) {
    ...
    "node_modules/readable-stream/lib/stream.js"(exports2, module) {
      var { ObjectDefineProperty, ObjectKeys, ReflectApply } = require_primordials(), {
        promisify: { custom: customPromisify }
      } = require_util(), { streamReturningOperators, promiseReturningOperators } = require_operators(), {
        codes: { ERR_ILLEGAL_CONSTRUCTOR }
      } = require_errors(), compose = require_compose(), { pipeline } = require_pipeline(), { destroyer } = require_destroy(), eos = require_end_of_stream(), promises2 = require_promises(), utils = require_utils(), Stream = module.exports = require_legacy().Stream;
  ...
  var Writable = require_writable(), NativeWritable = class NativeWritable2 extends Writable {
    #pathOrFdOrSink;
    #fileSink;
    #native = !0;
    _construct;
  ...
  const exports = require_stream(), promises = require_promises(), originalDestroy = exports.Readable.destroy;
  return exports._getNativeReadableStreamPrototype = getNativeReadableStreamPrototype, exports.NativeWritable = NativeWritable, Object.defineProperty(exports, "promises", {
    configurable: !0,
    enumerable: !0,
    get() {
      return promises;
    }
  }), exports[Symbol.for("::bunternal::")] = { _ReadableFromWeb, _ReadableFromWebForUndici }, exports.eos = require_end_of_stream(), exports;
})
