(function () {"use strict";
  ...
  const ptr = (arg1, arg2) => typeof arg2 === "undefined" ? ffi.ptr(arg1) : ffi.ptr(arg1, arg2), toBuffer = ffi.toBuffer, toArrayBuffer = ffi.toArrayBuffer, viewSource = ffi.viewSource, BunCString = ffi.CString, nativeLinkSymbols = ffi.linkSymbols, nativeDLOpen = ffi.dlopen, nativeCallback = ffi.callback, closeCallback = ffi.closeCallback;
  delete ffi.callback, delete ffi.closeCallback;
  ...
  var char = (val) => val | 0;
  ffiWrappers.fill(char), ffiWrappers[FFIType.uint8_t] = function uint8(val) {
    ...
    if (typeof val === "string")
      @throwTypeError("To convert a string to a pointer, encode it as a buffer");
    @throwTypeError(`Unable to convert ${val} to a pointer`);
  };
  ...
  ffiWrappers[FFIType.function] = function functionType(val) {
    ...
    if (!ptr2)
      @throwTypeError("Expected function to be a JSCallback or a number");
    return ptr2;
  };
